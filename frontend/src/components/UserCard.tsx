...
0
  ...
  return (
    <div className="bg-white rounded-lg h-[3.5rem] w-full flex md:justify-start md:items-center justify-center items-center py-3 border border-zinc-500/40 gap-3  md:px-6 px-0">
...
<div className="md:pl-[5rem]" onClick={()=>{
        sendButtonHandler(id)
